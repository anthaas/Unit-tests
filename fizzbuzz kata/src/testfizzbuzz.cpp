...
void TestFizzBuzz::secondTest(void)
{
	CPPUNIT_ASSERT((mTestObj->Convert(2).compare("2")) == 0);
}

void TestFizzBuzz::failingTest(void)
{
	CPPUNIT_ASSERT((mTestObj->Convert(1).compare("0")) == 0);
}
